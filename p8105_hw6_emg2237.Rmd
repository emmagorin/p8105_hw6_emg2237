...
**Both the density plot of r squared and the density plot of log(β̂ 0∗β̂1)show a roughly normal distribuion. R squared appears to have a mean of around .913 while log(β̂ 0∗β̂ 1) appears to have a mean of around 2.02. **
